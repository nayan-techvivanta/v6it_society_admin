...
const navItems = [
...

  {
    ...
    // subItems: [
    //   { name: "All Cards", path: "/cards", pro: false },
    //   { name: "Issue Card", path: "/cards/issue", pro: false },
    //   { name: "Card Types", path: "/cards/types", pro: false },
    //   { name: "Card Requests", path: "/cards/requests", pro: false },
    //   { name: "Card Reports", path: "/cards/reports", pro: false },
    // ],
  },
  {
  ...
  //     { name: "Students", path: "/school/students", pro: false },
  //     { name: "Teachers", path: "/school/teachers", pro: false },
  //     { name: "Subjects", path: "/school/subjects", pro: false },
  //     { name: "Timetable", path: "/school/timetable", pro: false },
  //     { name: "Attendance", path: "/school/attendance", pro: false },
  //     { name: "Exams", path: "/school/exams", pro: false },
  //   ],
  // },
  // {
  ...
  //   name: "Reader",
  //   subItems: [
  //     { name: "All Readers", path: "/readers", pro: false },
  //     { name: "Add Reader", path: "/readers/add", pro: false },
  //     { name: "Reader Groups", path: "/readers/groups", pro: false },
  //     { name: "Reading History", path: "/readers/history", pro: false },
  //     { name: "Reader Reports", path: "/readers/reports", pro: false },
  //   ],
  // },
];
