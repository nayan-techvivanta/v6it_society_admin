...
//   const handleSwitchChange = async (event) => {
//     // Disable switch interaction if card is LOST
...
//           onChange={handleSwitchChange}
//           disabled={loading || card.isDisabled} // Disable if loading or LOST
//           color="primary"
//           sx={{
//             "& .MuiSwitch-switchBase.Mui-checked": {
//               color: statusColors.assigned,
...
//               ? "#ccc" // Gray for LOST cards
//               : card.isAssigned
//                 ? statusColors.assigned
//                 : statusColors.unassigned,
//           }}
//         >
//           {card.isDisabled ? "LOST" : card.status}
//         </Typography>
//       }
//       labelPlacement="end"
//     />
...
//         isDisabled: card.card_status === "LOST",
